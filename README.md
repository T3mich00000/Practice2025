...
Проектная (учебная) практика проводилась в связке с выполнением проекта «***Лаборатория САПР. VR Concept***» по дисциплине «Проектная деятельность».
